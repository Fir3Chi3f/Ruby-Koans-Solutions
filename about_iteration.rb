...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #  Array.inject(default accumulator) { |accumulator, arrayItem| function to place into the accumulator }
  end
  ...
  # - The upcase_lines and assertion are only made if the file is actually opened. Such as if it were missing 
  #  those lines would still be attempted
