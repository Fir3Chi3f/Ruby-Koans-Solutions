...
class AboutSymbols < Neo::Koan
  ...
  #
  #  - Based on the above, if symbols are the equivelant than they're also the same. 
  #  I'm not sure why we'd want to convert them to strings just to compare since there
  #  string counterparts are also likely going to be the same unless I'm missing somethings
