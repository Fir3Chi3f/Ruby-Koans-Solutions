...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #  - Likely simply because there are more cases were we don't care
    #   about proserving the original string than not.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised? 
    # - No? Maybe this is for those who don't know to start counting from 
    #   zero.
  end
